"""
OpenAI gpt-5-miniiniini Responses API service for chat functionality with streaming support
"""
...
class OpenAIService:
    """Service for interacting with OpenAI gpt-5-miniiniini Responses API."""
    ...
    def __init__(self):
        ...
        self.model = "gpt-5-miniiniini"  # gpt-5-mini5-mini5-mini model
        
        # Culture intelligence instructions for gpt-5-miniiniini Responses API
...
Always be empathetic, professional, and focused on positive culture building. Use data-driven insights while maintaining a human-centered approach. Be concise yet comprehensive in your responses."""
    ...
    async def chat_completion_streaming(
        ...
        """
        Generate streaming chat completion using gpt-5-miniiniini Responses API.
        ...
        try:
            ...
            logger.info(f"Initiating gpt-5-miniiniini Responses API call with web search: {use_tools}")
            ...
            logger.error(f"Error in gpt-5-miniiniini Responses API: {str(e)}")
    ...
    async def get_chat_completion(
        ...
        """
        Get a complete chat response using gpt-5-miniiniini Responses API (non-streaming).
        ...
        try:
            ...
            logger.error(f"Error in gpt-5-miniiniini chat completion: {str(e)}")
...
Focus on questions that generate actionable insights for improving workplace culture."""
        ...
        try:
            ...
            logger.error(f"Error generating survey questions with gpt-5-miniiniini: {str(e)}")
